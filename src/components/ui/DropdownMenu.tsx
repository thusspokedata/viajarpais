...
const itemBase =
  ...
  "text-[var(--text-sm)] text-[var(--text-primary)] outline-none " +
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      itemBase,
      destructive && "text-[var(--danger-fg)] data-[highlighted]:bg-[var(--danger-bg)]",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <Circle className="h-2 w-2 fill-current text-[var(--brand-primary)]" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-[10px] font-display uppercase tracking-[var(--tracking-caps)]",
      "text-[var(--text-muted)]",
      className
    )}
    {...props}
...
export const DropdownMenuShortcut = ({
  ...
  <span
    className={cn(
      "ml-auto text-[var(--text-xs)] font-mono text-[var(--text-muted)]",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(itemBase, "data-[state=open]:bg-[var(--surface-sunken)]", className)}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "rounded-[var(--radius-md)] border border-[var(--border-default)]",
      "bg-[var(--surface-raised)] shadow-[var(--shadow-elevated)] p-1",
      "data-[state=open]:animate-[vp-reveal-down_var(--duration-fast)_var(--ease-decelerate)]",
      className
    )}
    {...props}
